...
/***/ (function(module, exports, __webpack_require__) {
	...
	var postEvents = __webpack_require__(43);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    ...
	    production: 'https://protected-mesa-82595.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var pagesUi = __webpack_require__(36);
	var loadPages = __webpack_require__(39);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var pagesApi = __webpack_require__(35);
	var ui = __webpack_require__(36);
	var pagesEvents = __webpack_require__(39);
	...
	var signInSuccess = function signInSuccess(data) {
	  ...
	  pagesApi.getAllPages().then(layout.loadPages(data)).then(ui.getAllUserPagesSuccess);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var loadPages = function loadPages(response) {
	  var pageTemplate = __webpack_require__(12);
	  var content = pageTemplate({ pages: response.pages });
	  $('#app').empty();
	  $('#app').html(content);
	};

	var loadVisitorPages = function loadVisitorPages(response) {
	  var pageTemplate = __webpack_require__(32);
	  var content = pageTemplate({ pages: response.pages });
	  $('#app').empty();
	  $('#app').html(content);
	};

	var loadUserPages = function loadUserPages() {
	  var userPageTemplate = __webpack_require__(33);
	  var content = userPageTemplate({ pages: store.userPages });
	  $('#app').empty();
	  $('#app').append(content);
	};

	var loadPagePosts = function loadPagePosts(response) {
	  var pagePostsTemplate = __webpack_require__(34);
	  var content = pagePostsTemplate({ posts: store.currentPagePosts });
	  $('#app').empty();
	  $('#app').html(content);
	};
	...
	module.exports = {
	  ...
	  loadVisitorPages: loadVisitorPages
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <div class=\"card col-xs-3\" style=\"padding: 20px; height: 200px; margin: 20px;\">\n    <div class=\"card-block\" style=\"padding: 10px\">\n      <h3 class=\"card-title page-card-title\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "</h3>\n      <h5 class=\"card-text page-card-description\">Description: "
	    ...
	    + "\" class=\"btn btn-info view-page-posts-button\">View Posts</button>\n    </div>\n  </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<div class=\"container welcome-landing-jumbotron signed-in-view\">\n  <div class=\"jumbotron jumbotron-fluid\">\n      <h1>All pages</h1>\n      <p>Showing <b>"
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.pages : depth0)) != null ? stack1.length : stack1), depth0))
	    + "</b> pages from all users.</p>\n      <!-- <div id=\"user-messages\" class=\"user-messages col-xs-12\" style=\"margin: 15px;\"></div> -->\n\n  </div>\n</div>\n\n<div class=\"container all-pages-view signed-in-view\">\n\n\n"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <div class=\"card col-xs-3\" style=\"padding: 20px; height: 200px; margin: 20px;\">\n    <div class=\"card-block\" style=\"padding: 10px\">\n      <h3 class=\"card-title page-card-title\">"
	    ...
	    + "</h5>\n      <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-info view-visitor-page-posts-button\">Sign-in to View</button>\n    </div>\n  </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <div class=\"card col-xs-3\" style=\"margin: 20px; padding: 20px;\">\n    <h3 class=\"card-title page-card-title\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "</h3>\n    <div class=\"card-block\" style=\"padding: 10px\">\n      <h4 class=\"card-text page-card-description overflow: auto;\">Description: </h4>\n      <p>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "</p>\n    </div>\n      <div class=\"card-footer\">\n        <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-info view-page-posts-button\">View Posts</button>\n        <br>\n        <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-default update-page-button\">Update Page</button>\n        <br>\n        <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-default delete-page-button\">Delete Page</button>\n      </div>\n  </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<div class=\"container welcome-landing-jumbotron signed-in-view\">\n  <div class=\"jumbotron jumbotron-fluid\">\n      <h1>My pages</h1>\n      <p>User has <b>"
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.pages : depth0)) != null ? stack1.length : stack1), depth0))
	    + "</b> pages</p>\n      <button id=\"show-create-page-forms\" class=\"signed-in-view btn btn-lg btn-info\">+ Page</button>\n\n      <!-- <div id=\"user-messages\" class=\"user-messages col-xs-12\" style=\"margin: 15px;\"></div> -->\n\n  </div>\n</div>\n<br>\n\n<div class=\"container user-pages-view signed-in-view\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.pages : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</div>\n";
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <div class=\"card col-xs-3\" style=\"margin: 20px; padding: 20px;\">\n    <div class=\"card-block\" style=\"padding: 10px\">\n      <h4 class=\"card-title post-card-title\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "</h4>\n      <h4 class=\"card-text post-card-description\">Description: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "</h4>\n      <h6 class=\"text-muted\">"
	    ...
	    + "</p>\n      <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-warning edit-posts-button\">Edit Post</button>\n      <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-danger delete-post-button\">Delete Post</button>\n    </div>\n  </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<div class=\"container welcome-landing-jumbotron signed-in-view\">\n  <div class=\"jumbotron jumbotron-fluid\">\n      <h1>Posts for page </h1>\n      <p>This page has <b>"
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.posts : depth0)) != null ? stack1.length : stack1), depth0))
	    + "</b> posts</p>\n      <button class=\"btn btn-info view-create-post-fields-button\">+ New Post</button>\n\n      <!-- <div id=\"user-messages\" class=\"user-messages col-xs-12\" style=\"margin: 15px;\"></div> -->\n  </div>\n</div>\n\n\n\n<div class=\"container all-pages-posts-view signed-in-view\">\n"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getAllVisitorPages = function getAllVisitorPages() {
	  return $.ajax({
	    url: config.apiOrigin + '/pages/',
	    method: 'GET'
	  });
	...
	var newUserPage = function newUserPage(data) {
	  return $.ajax({
	    method: 'POST',
	    url: config.apiOrigin + '/pages/',
	    headers: {
	...
	var getAllUserPages = function getAllUserPages(userId) {
	  return $.ajax({
	    url: config.apiOrigin + '/pages/',
	    method: 'GET',
	    headers: {
	...
	var getSingleUserPage = function getSingleUserPage(pageId) {
	  return $.ajax({
	...
	var deleteUserPage = function deleteUserPage(pageId) {
	  return $.ajax({
	    method: 'DELETE',
	    url: config.apiOrigin + '/pages/' + pageId,
	    headers: {
	...
	var updateUserPage = function updateUserPage(data) {
	  return $.ajax({
	    method: 'PATCH',
	...
	module.exports = {
	  ...
	  getAllUserPages: getAllUserPages,
	  getSingleUserPage: getSingleUserPage,
	  deleteUserPage: deleteUserPage,
	  updateUserPage: updateUserPage,
	  getAllVisitorPages: getAllVisitorPages
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var postsApi = __webpack_require__(37);
	var postsUi = __webpack_require__(38);

	var userPagesMessage = function userPagesMessage(message) {
	  $('.user-messages').text(message);
	  setTimeout(function () {
	    $('.user-messages').show();
	  }, 500);
	...
	var updatePageSuccess = function updatePageSuccess(data) {
	  ...
	  api.getAllUserPages(data).then(getAllUserPagesSuccess).catch(getAllUserPagesFailure);
	  $;
	};
	...
	var getAllPagesSuccess = function getAllPagesSuccess(response) {
	...
	var getAllVisitorPagesSuccess = function getAllVisitorPagesSuccess(response) {
	  layout.loadVisitorPages(response);
	  $(document).on('click', '.view-visitor-page-posts-button', function () {
	    $('#sign-in-modal').modal('show');
	    $('.modal-title').text('Sign-In');
	  });
	};

	var getAllVisitorPagesFailure = function getAllVisitorPagesFailure(error) {
	...
	var newUserPageSuccess = function newUserPageSuccess(response) {
	...
	var newUserPageFailure = function newUserPageFailure(error) {
	...
	// GET PAGE POSTS | GET PAGE POSTS | GET PAGE POSTS | GET PAGE POSTS | GET PAGE POSTS |
	// GET PAGE POSTS | GET PAGE POSTS | GET PAGE POSTS | GET PAGE POSTS | GET PAGE POSTS |
	var onGetPagePosts = function onGetPagePosts(event) {
	  event.preventDefault();
	  var pageId = $(event.target).attr('data-id');
	  store.currentPageId = pageId;
	  postsApi.getPosts().then(postsUi.getPostsSuccess).catch(postsUi.getPostsFailure);
	};

	var getAllUserPagesSuccess = function getAllUserPagesSuccess(data) {
	  store.pages = data.pages;
	  store.userPages = data.pages.filter(function (page) {
	...
	var getAllUserPagesFailure = function getAllUserPagesFailure(error) {
	  console.error(error);
	};

	var onDeleteUserPage = function onDeleteUserPage(event) {
	  event.preventDefault();
	  var removeUserPage = $(event.target).attr('data-id');
	  api.deleteUserPage(removeUserPage).then(deleteUserPageSuccess).catch(deleteUserPageFailure).then(function () {
	    api.getAllUserPages().then(getAllUserPagesSuccess).catch(getAllUserPagesFailure);
	  });
	};

	var deleteUserPageSuccess = function deleteUserPageSuccess(response) {
	  userPagesMessage('Page deleted!');
	};

	var deleteUserPageFailure = function deleteUserPageFailure(error) {
	  userPagesMessage('Failed to update page');
	...
	module.exports = {
	  ...
	  newUserPageSuccess: newUserPageSuccess,
	  newUserPageFailure: newUserPageFailure,
	  getAllUserPagesSuccess: getAllUserPagesSuccess,
	  getAllUserPagesFailure: getAllUserPagesFailure,
	  // refreshUserPagesList,
	  getAllVisitorPagesSuccess: getAllVisitorPagesSuccess,
	  getAllVisitorPagesFailure: getAllVisitorPagesFailure,
	  onGetPagePosts: onGetPagePosts,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var userPostsMessage = function userPostsMessage(message) {
	  $('.user-messages').text(message);
	  setTimeout(function () {
	    $('.user-messages').show();
	  }, 500);
	...
	var createPostSuccess = function createPostSuccess(response) {
	  ...
	  api.getPosts().then(getPostsSuccess).catch(getPostsFailure);
	};
	...
	var getPostsSuccess = function getPostsSuccess(data) {
	  ...
	  var currentPagePosts = store.posts.filter(function (post) {
	...
	var getPostsFailure = function getPostsFailure(error) {
	...
	module.exports = {
	  ...
	  userPostsMessage: userPostsMessage
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createPageFieldsView = __webpack_require__(41);
	var updatePageFieldsView = __webpack_require__(42);
	...
	var onLoadAllPages = function onLoadAllPages() {
	  api.getAllVisitorPages().then(ui.getAllVisitorPagesSuccess).catch(ui.getAllVisitorPagesFailure);
	};

	var onGetAllUserPages = function onGetAllUserPages(event) {
	  event.preventDefault();
	  api.getAllUserPages().then(ui.getAllUserPagesSuccess).catch(ui.getAllUserPagesFailure);
	};

	var onGetAllPagesChain = function onGetAllPagesChain() {
	  api.getAllVisitorPages().then(ui.getAllPagesSuccess).catch(ui.getAllPagesFailure);
	};

	var onNewUserPage = function onNewUserPage(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.newUserPage(data).then(ui.newUserPageSuccess).then(function () {
	    api.getAllUserPages(store.pages[0]._owner).then(ui.getAllUserPagesSuccess).catch(ui.getAllUserPagesFailure);
	...
	var onUpdatePage = function onUpdatePage(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.updateUserPage(data).then(ui.updatePageSuccess).catch(ui.updatePageFailure);
	};

	var onShowCreatePageForms = function onShowCreatePageForms(event) {
	  event.preventDefault();
	  var createPageFieldsHTML = createPageFieldsView();
	  $('#app').empty();
	  $('#app').append(createPageFieldsHTML);
	};

	var onShowUpdatePageForm = function onShowUpdatePageForm(event) {
	  var data = this.dataset.id;
	  event.preventDefault();
	  var updatePageFieldsHTML = updatePageFieldsView();
	  $('#app').empty();
	...
	module.exports = {
	  ...
	  onGetAllPagesChain: onGetAllPagesChain
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div id=\"create-new-page-forms-id\" class=\"signed-in-view col-xs-8\">\n\n    <div class=\"create-new-page-forms-header\">\n      <h2>Create New Page</h2>\n    </div>\n\n    <div class=\"create-new-page-forms-body\">\n\n      <form id=\"create-new-page-forms-submit\" class=\"form-inline\">\n        <div class=\"form-group\">\n          <label for=\"page-title\">Page Title*</label>\n          <input id=\"page-title-input-id\" type=\"text\" name=\"page[title]\" class=\"form-control\" autofocus required>\n        </div>\n        <br>\n        <div class=\"form-group\">\n          <label for=\"page-description\">Page Description*</label>\n          <input id=\"page-description-input-id\" type=\"text\" name=\"page[description]\" class=\"form-control\" required>\n        </div>\n        <br>\n        <div class=\"form-group create-new-page-buttons-div\">\n          <button id=\"create-page-button\" type=\"submit\" class=\"btn btn-info submit-button-class\">Create</button>\n          <!-- <button id=\"cancel-create-page-button\" type=\"submit\" class=\"btn btn-warning\">Cancel</button> -->\n        </div>\n    </form>\n\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div id=\"update-new-page-forms-id\" class=\"signed-in-view col-xs-8\">\n\n    <div class=\"update-new-page-forms-header\">\n      <h2>Update Page</h2>\n    </div>\n\n    <div class=\"update-new-page-forms-body\">\n\n      <form id=\"update-new-page-forms-submit\" class=\"form-inline\">\n        <div class=\"form-group\">\n          <div class=\"form-group\">\n            <input type=\"hidden\" id=\"page-id-input\" name=\"page[id]\" class=\"form-control\" required>\n          </div>\n          <label for=\"page-title\">Page Title*</label>\n          <input id=\"page-title-input-id\" type=\"text\" name=\"page[title]\" class=\"form-control\" autofocus required>\n        </div>\n        <br>\n        <div class=\"form-group\">\n          <label for=\"page-description\">Page Description*</label>\n          <input id=\"page-description-input-id\" type=\"text\" name=\"page[description]\" class=\"form-control\" required>\n        </div>\n        <br>\n        <div class=\"form-group update-new-page-buttons-div\">\n          <button id=\"update-page-button\" type=\"submit\" class=\"btn btn-info submit-button-class\">Update</button>\n          <!-- <button type=\"submit\" class=\"btn btn-warning submit-button-blass\">Cancel</button> -->\n        </div>\n    </form>\n\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(40);
	var store = __webpack_require__(9);
	var createPostFieldsView = __webpack_require__(44);
	var updatePostFieldsView = __webpack_require__(45);
	var pagesUi = __webpack_require__(36);
	...
	var onShowUpdatePostForm = function onShowUpdatePostForm(event) {
	  var data = this.dataset.id;
	  event.preventDefault();
	  var updatePostFieldsHTML = updatePostFieldsView();
	  $('#app').empty();
	...
	var onShowCreatePostForms = function onShowCreatePostForms(event) {
	  event.preventDefault();
	  var createPostFieldsHTML = createPostFieldsView();
	  $('#app').empty();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div id=\"create-new-post-forms-id\" class=\"signed-in-view col-xs-8\">\n\n    <div class=\"create-new-post-forms-header\">\n      <h2>Create New Post</h2>\n    </div>\n\n    <div class=\"create-new-post-forms-body\">\n\n      <form id=\"create-new-post-forms-submit\" class=\"form-inline\">\n        <div class=\"form-group\">\n          <!-- <label for=\"post-parent-page\">Post Parent Page Id*</label> -->\n          <input id=\"post-parent-page-input-id\" type=\"hidden\" name=\"post[_page]\" class=\"form-control\" required>\n        </div>\n        <div class=\"form-group\">\n          <label for=\"post-title\">Post Title*</label>\n          <input id=\"post-title-input-id\" type=\"text\" name=\"post[title]\" class=\"form-control\" autofocus required>\n        </div>\n        <br>\n        <br>\n        <div class=\"form-group\">\n          <label for=\"post-content\">Post Content*</label>\n          <input id=\"post-content-input-id\" type=\"text\" name=\"post[content]\" class=\"form-control\" required>\n        </div>\n        <div class=\"form-group create-new-post-buttons-div\">\n          <button id=\"create-new-post-button\" type=\"submit\" class=\"btn btn-info submit-button-class\">Create</button>\n          <!-- <button type=\"submit\" class=\"btn btn-warning submit-button-class\">Cancel</button> -->\n        </div>\n    </form>\n\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div id=\"update-new-post-forms-id\" class=\"signed-in-view col-xs-8\">\n\n    <div class=\"update-new-post-forms-header\">\n      <h2 class=\"update-post-header\">Update Post</h2>\n    </div>\n\n    <div class=\"update-new-post-forms-body\">\n\n      <form id=\"update-new-post-forms-submit\" class=\"form-inline\">\n        <div class=\"form-group\">\n          <!-- <label for=\"post-parent-page\">Post Parent Page Id*</label> -->\n          <input id=\"post-parent-page-input-id\" type=\"hidden\" name=\"post[_page]\" class=\"form-control\" required>\n        </div>\n        <div class=\"form-group\">\n          <input type=\"hidden\" id=\"post-id-input\" name=\"post[id]\" class=\"form-control\" required>\n        </div>\n        <div class=\"form-group\">\n          <label for=\"post-title\">Post Title*</label>\n          <input id=\"post-title-input-id\" type=\"text\" name=\"post[title]\" class=\"form-control\" autofocus required>\n        </div>\n        <br>\n        <br>\n        <div class=\"form-group\">\n          <label for=\"post-content\">Post Content*</label>\n          <input id=\"post-content-input-id\" type=\"text\" name=\"post[content]\" class=\"form-control\" required>\n        </div>\n        <div class=\"form-group update-new-post-buttons-div\">\n          <button id=\"update-new-post-button\" type=\"submit\" class=\"btn btn-success submit-button-class\">Update</button>\n          <!-- <button id=\"cancel-update-post-forms-button\" class=\"btn btn-warning\">Cancel</button> -->\n        </div>\n    </form>\n\n  </div>\n</div>\n";
	},"useData":true});
